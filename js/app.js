(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-main__body")) new core(".slider-main__body", {
            ...
            navigation: {
                nextEl: ".slider-main .slider-arrows__arrow_next",
                prevEl: ".slider-main .slider-arrows__arrow_prev"
            }
        });
        if (document.querySelector(".slider-rooms__body")) {
            let roomSwiper = new core(".slider-rooms__body", {
                modules: [ Navigation, Pagination, Parallax ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
                ...
                navigation: {
                    nextEl: ".slider-rooms .slider-arrows__arrow_next",
                    prevEl: ".slider-rooms .slider-arrows__arrow_prev"
                }
            });
            if (window.innerWidth < 479.98 && isMobile.any()) {
                let bullets = document.querySelectorAll(".slider-rooms .swiper-pagination-bullet");
                bullets.forEach(((bullet, index) => {
                    bullet.addEventListener("click", (() => {
                        console.log(index);
                        roomSwiper.slideTo(index, 800);
                    }));
                }));
            }
        }
        if (document.querySelector(".slider-tips__body")) new core(".slider-tips__body", {
            ...
            navigation: {
                nextEl: ".slider-tips .slider-arrows__arrow_next",
                prevEl: ".slider-tips .slider-arrows__arrow_prev"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.05,
        ...
        function documentActions(e) {
            ...
            if (window.innerWidth > 768 && isMobile.any()) {
                if (targetElement.classList.contains("menu__arrow")) {
                    const hoveredElement = document.querySelector(".menu__item._hover");
                    if (hoveredElement) hoveredElement.classList.remove("_hover");
            ...
            if (targetElement.classList.contains("search-form__icon")) document.querySelector(".search-form").classList.toggle("active"); else if (!targetElement.closest(".search-form") && document.querySelector(".search-form.active")) document.querySelector(".search-form").classList.remove("active");
            ...
            if (targetElement.classList.contains("cart-header__icon") || targetElement.closest(".cart-header__icon")) {
                ...
                e.preventDefault();
            } else if (!targetElement.closest(".cart-header") && !targetElement.classList.contains("actions-product__button") && !targetElement.classList.contains("buttons-popup__btn_disagree")) document.querySelector(".cart-header").classList.remove("_active");
